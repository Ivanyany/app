...
import com.ivan.app.entity.BaseResponse;
import com.ivan.app.entity.VideoEntity;
import com.ivan.app.listener.OnItemChildClickListener;
import com.ivan.app.listener.OnItemClickListener;
import com.ivan.app.view.CircleTransform;
...
//        vh.tvCollect.setText(String.valueOf(videoEntity.getCollectNum()));
    ...
    private void updateCount(int vid, int type, boolean flag) {
        ...
        Api.config(ApiConfig.VIDEO_UPDATE_COUNT, params).postRequest(mContext, new IvanCallback() {
            @Override
