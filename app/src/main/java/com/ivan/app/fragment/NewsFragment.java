...
import com.ivan.app.activity.WebActivity;
import com.ivan.app.adapter.NewsAdapter;
import com.ivan.app.api.Api;
import com.ivan.app.api.ApiConfig;
import com.ivan.app.api.IvanCallback;
import com.ivan.app.entity.NewsEntity;
import com.ivan.app.entity.NewsListResponse;
...
//                showToast("点击");
    ...
    private void getNewsList(final boolean isRefresh) {
        ...
        Api.config(ApiConfig.NEWS_LIST, params).getRequest(getActivity(), new IvanCallback() {
            @Override
