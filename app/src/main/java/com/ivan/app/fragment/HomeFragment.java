...
import com.ivan.app.adapter.HomeAdapter;
import com.ivan.app.api.Api;
import com.ivan.app.api.ApiConfig;
import com.ivan.app.api.IvanCallback;
import com.ivan.app.entity.CategoryEntity;
import com.ivan.app.entity.VideoCategoryResponse;
...
public class HomeFragment extends BaseFragment {
    ...
    private void getVideoCategoryList() {
        ...
        Api.config(ApiConfig.VIDEO_CATEGORY_LIST, params).getRequest(getActivity(), new IvanCallback() {
            @Override
