...
import com.ivan.app.adapter.VideoAdapter;
import com.ivan.app.api.Api;
import com.ivan.app.api.ApiConfig;
import com.ivan.app.api.IvanCallback;
import com.ivan.app.entity.VideoEntity;
import com.ivan.app.entity.VideoListResponse;
import com.ivan.app.listener.OnItemChildClickListener;
import com.ivan.app.util.Tag;
import com.ivan.app.util.Utils;
...
//        mVideoView.setUrl(proxyUrl);
    ...
    private void getVideoList(final boolean isRefresh) {
        ...
        Api.config(ApiConfig.VIDEO_LIST_BY_CATEGORY, params).getRequest(getActivity(), new IvanCallback() {
            @Override
