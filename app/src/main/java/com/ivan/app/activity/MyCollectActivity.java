...
//        getVideoViewManager().add(mVideoView, Tag.LIST);
    ...
    private void getVideoList() {
        ...
        Api.config(ApiConfig.VIDEO_MYCOLLECT, params).getRequest(this, new IvanCallback() {
            @Override
